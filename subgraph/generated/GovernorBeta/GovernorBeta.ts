...
export class GovernorBeta__getActionsResult {
...
export class GovernorBeta__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class GovernorBeta__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class GovernorBeta__receiptsResult {
  value0: boolean;
  value1: boolean;
  value2: BigInt;
...
export class GovernorBeta extends ethereum.SmartContract {
  static bind(address: Address): GovernorBeta {
    return new GovernorBeta("GovernorBeta", address);
  }
  ...
  getActions(proposalId: BigInt): GovernorBeta__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new GovernorBeta__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<GovernorBeta__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new GovernorBeta__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): GovernorBeta__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return changetype<GovernorBeta__getReceiptResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<GovernorBeta__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GovernorBeta__getReceiptResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  proposals(param0: BigInt): GovernorBeta__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new GovernorBeta__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<GovernorBeta__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovernorBeta__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  receipts(param0: BigInt, param1: Address): GovernorBeta__receiptsResult {
    let result = super.call(
      "receipts",
    ...
    return new GovernorBeta__receiptsResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBigInt()
    );
  ...
  try_receipts(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<GovernorBeta__receiptsResult> {
    let result = super.tryCall(
      "receipts",
      "receipts(uint256,address):(bool,bool,uint96)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovernorBeta__receiptsResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toBigInt()
      )
